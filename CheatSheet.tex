...
\begin{tabular}{@{}ll@{}}
	...
	source .cpp    & API in .h, definitions in .cpp file \\
	               & \\
	Aligned        & \verb!totalSum = a + b + c + ! \\
	split          & \verb!           d + e;! \\
	               & \verb!function(param1, param2,! \\
	               & \verb!         param3);! \\
	               & \verb!for (int tableNo = 0; tableNo < nTables;! \\
	               & \verb!     tableNo += tableStep)! \\
\end{tabular}
...
\begin{tabular}{@{}ll@{}}
	Class layout  & \verb!Class MyClass! \\
	              ...
	              & \verb!};! \\
	              & \\
	Use explicit  & \verb!floatValue = static_cast<float>(intValue);! \\
	conversions   & NOT: \verb!floatValue = intValue;!\\
\end{tabular}
...
\begin{tabular}{@{}ll@{}}
	...
	references    & \verb!int &x;! // NOT: \verb!int& x;! \\
	              & \\
	Implicit test & \texttt{if (nLines != 0)} // NOT: \verb!if (nLines)! \\
...
\begin{tabular}{@{}ll@{}}
	...
	NOT:          & \verb!for (i = 0, sum = 0; i < 100; i++)! \\
	              ...
	              & \\
	Init loop vars& \verb!isDone = false;! \\
	just before   & \texttt{while (!isDone) \{} \\ 
